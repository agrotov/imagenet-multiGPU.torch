...
function get_variance_gradient(rewards_arg,probability_actions_teacher_model, risk, gradient_of_risk)
    ...
    diff_mean_weighted_rewards_of_logging_policy_square = torch.cmul(diff_mean_weighted_reawrds_of_logging_policy,diff_mean_weighted_reawrds_of_logging_policy)
