...
------------------------------------------------------------------------------
local autoMaximizationCriterion = function(prediction, target)
--    print ("autoMaximizationCriterion prediciton")
--    print(prediction)
--    print(prediction:size())
--    print(prediction:type())
    return torch.sum(torch.cmul(prediction:float(),target))
end
