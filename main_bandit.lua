...
--       print("opt.batchSize",opt.batchSize,logged_data:size(1))
    ...
    --      exit()
          outputs = trainBatch_bandit(inputs,actions,rewards,probability_of_actions, optimState, targets, temperature, k)
...
data_path = "/var/scratch/agrotov/bandit_imagenet/logged_dataset_with_offsets_small"
